...
/* Create a test menu */
static Menu *create_test_menu(X11FocusContext *focus_ctx, const char *id,
                              uint16_t mod, uint8_t trigger) {
...
static void test_menu_registration(void) {
  ...
  /* Create test menus */
  Menu *menu1 = create_test_menu(manager->focus_ctx, "Menu 1", XCB_MOD_MASK_4,
                                 31); // Super+i
  Menu *menu2 = create_test_menu(manager->focus_ctx, "Menu 2", XCB_MOD_MASK_4,
                                 32); // Super+o
...
static void test_menu_activation(void) {
  ...
  /* Create test menu */
  Menu *menu = create_test_menu(manager->focus_ctx, "Test Menu", XCB_MOD_MASK_4,
                                31); // Super+i
